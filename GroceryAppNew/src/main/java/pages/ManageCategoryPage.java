...
public class ManageCategoryPage {
	...
	@FindBy(xpath="//a[@href='https://groceryapp.uniqassosiates.com/admin/list-category'and @class='small-box-footer']")WebElement managecategorymoreinfobutton;
	...
	@FindBy(id = "category")WebElement categorynamefield;
	@FindBy(xpath = "//li[@id='134-selectable']")WebElement groupnamefield;
	@FindBy(xpath = "//input[@id='main_img']")WebElement choosefilefield;
	@FindBy(xpath = "//button[@type='submit']")WebElement savebuttonfield;
