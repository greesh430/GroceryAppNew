...
public class ManageNewsPage {
    ...
    @FindBy(xpath = "//a[@class='btn btn-rounded btn-danger']")WebElement manageNewsAddMenu;  
	//@FindBy(xpath = "//span[text()='Manage News']")WebElement manageNewsMenu;
   //@FindBy(xpath = "//a[@class='btn btn-rounded btn-danger']")WebElement addNewNewsButton; 
    //@FindBy(xpath = "(//a[@class='btn btn-rounded btn-danger'])[2]")WebElement addNewNewsButton;
   // @FindBy(xpath = "//a[contains(text(),'Add News')]")WebElement addNewNewsButton;
	//@FindBy(xpath = "//a[contains(@class,'btn btn-rounded btn-danger')]")WebElement addNewNewsButton;
