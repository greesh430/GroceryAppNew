...
public class AdminUserPage {
	...
	@FindBy(xpath ="//a[@class='btn btn-rounded btn-danger']")WebElement addnewbuttonclick;
//	@FindBy(xpath="//input[@id='username']")WebElement newUserUsername;
//	@FindBy(xpath="//input[@id='password']")WebElement newUserPassword;
	@FindBy(xpath = "//input[@name='username']") WebElement newUserUsername;
	@FindBy(xpath = "//input[@name='password']") WebElement newUserPassword;
